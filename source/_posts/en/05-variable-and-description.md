...
permalink: en/docs/05-variable-and-description/
categories:
- Basics
---
...
Detailed usage (basic usage, context factories, preview logic, damage/block wrappers, icon counts, reading computed values, a complete example) is in `RitsuLib Chapter 19: Computed Dynamic Variables`.
